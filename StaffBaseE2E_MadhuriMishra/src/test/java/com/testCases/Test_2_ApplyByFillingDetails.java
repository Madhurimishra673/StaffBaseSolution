...
public class Test_2_ApplyByFillingDetails extends Testbase{
	...
	public void validateFormSubmissionWithLinkdln(String FirstName, String LastName, String Email, String Phone, String FileLocation,String Resume,String CoverLetter, String visaInfo,String Repository) throws Exception, SQLException {
		AllureLogger.startTest();
		try {
			...
			softAssert.assertEquals(apply.validateformSubmissionIsSuccessfull(), true, "Submit Application");
